...
def obtener_palabra_válida(palabras):
    # Seleccionar una palabra al azar de la list
    # de palabras válidas
...
def ahorcado():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        print(f"Te quedan {vidas} vidas y has usado éstas letras: {' '.join(letras_adivinadas)}")
        ...
        if letra_usuario in abecedario - letras_adivinadas:
            ...
            print("\nYa esogiste esa letra. Por favor escoge una letra nueva.")
        else:
